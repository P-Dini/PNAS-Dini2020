 ...
 * @author pouya
 */
public class ProcessGZFileTed_Final {
    ...
    public static void main(String[] args) {
        ...
        String filename = "6mo_L57_N100_Trio.vcf.gz";
        try{
...
*/
    ...
    private static boolean ignore(String[] genotype){
        ...
        if(genotype[3].equals(genotype[2])){
            return true;
        }
    ...
    private static String isInteresting(String[] genotype){
        ...
        if(!genotype[0].equals("..") && isInheritedFrom(genotype[0],genotype[3]) && !isInheritedFrom(genotype[0],genotype[2])){
            return "F1R2_Mat";
        }
        ...
        if(!genotype[1].equals("..") && isInheritedFrom(genotype[1],genotype[3]) && !isInheritedFrom(genotype[1],genotype[2])){
            return "F2R1_Mat";
        }
